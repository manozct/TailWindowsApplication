...
namespace CourierBackOfficeManagement.Login {
    using System;
    ...
    public partial class LoginWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public LoginWebService() {
            this.Url = global::CourierBackOfficeManagement.Properties.Settings.Default.CourierBackOfficeManagement_Login_LoginWebService;
        ...
        public bool LoginUser(int PortalID, string UserName, string Password, string token) {
        ...
        /// <remarks/>
        public void LoginUserAsync(int PortalID, string UserName, string Password, string token) {
            this.LoginUserAsync(PortalID, UserName, Password, token, null);
        }
        
        /// <remarks/>
        public void LoginUserAsync(int PortalID, string UserName, string Password, string token, object userState) {
            ...
            this.InvokeAsync("LoginUser", new object[] {
                        ...
                        UserName,
                        Password,
                        token}, this.LoginUserOperationCompleted, userState);
        }
